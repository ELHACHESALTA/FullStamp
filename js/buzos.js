...
function crearTarjetasBuzos(articulos) {
    articulos.forEach(articulo => {
        var nuevoBuzo = document.createElement("div");
        nuevoBuzo.classList = "tarjeta-articulo";
        ...
        contenedorTarjetas.appendChild(nuevoBuzo);
        nuevoBuzo
